...
class FinalGoodsFirm(abce.Agent, abce.Firm):
    ...
    def production(self):
        ...
        if can_produce:
            ...
            print(f"    Final Goods Firm {self.id}: Produced {self.current_output_quantity:.2f} {self.output}s using full inputs")
        else:
            ...
            if production_scale > 0:
                ...
                print(f"    Final Goods Firm {self.id}: Partial production {scaled_output:.2f} {self.output}s (scale: {production_scale:.2f})")
            else:
                # No production possible
                print(f"    Final Goods Firm {self.id}: No production - insufficient inputs")
